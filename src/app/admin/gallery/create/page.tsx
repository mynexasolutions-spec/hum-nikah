...
export default function CreateGalleryItemPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto w-full space-y-4 sm:space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] sm:text-xs text-brand-secondary mt-0.5">Add a new photo to your gallery.</p>
          </div>
        </div>
      ...
      <form id="gallery-form" onSubmit={handleSubmit} className="flex flex-col lg:flex-row gap-4 sm:gap-6 items-start">
