...
export default function EditGalleryForm({ item }: { item: GalleryItemType }) {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-[1200px] mx-auto w-full h-[calc(100vh-theme(spacing.20))] flex flex-col">
      <div className="mb-4 flex items-center justify-between gap-4 flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-brand-secondary">Update details for this gallery item.</p>
          </div>
        </div>
      ...
      <form id="edit-gallery-form" onSubmit={handleSubmit} className="flex-grow flex flex-col lg:flex-row gap-6 min-h-0">
