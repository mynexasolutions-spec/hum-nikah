...
export default function CreateBlogPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-[1600px] mx-auto w-full h-[calc(100vh-theme(spacing.20))] flex flex-col">
      <div className="mb-4 flex items-center justify-between gap-4 flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-brand-secondary">Publish a new article to your blog.</p>
          </div>
        </div>
      ...
      <form id="blog-form" onSubmit={handleSubmit} className="flex-grow flex flex-col lg:flex-row gap-6 min-h-0">
